# Generated by Django 3.2.16 on 2022-10-25 08:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('n', 'Новая'), ('w', 'Принято в работу'), ('d', 'Выполнено')], default='n', max_length=1, verbose_name='Статус')),
